...
const InputSearchableSelect = ({ ...props }) => {
  ...
  return (
    <>
      <input
        id={rest.name}
        className={`appearance-none block w-full px-3 py-2 border rounded-md shadow-sm focus:outline-hidden  focus:border-indigo-500 sm:text-sm pr-10 border-gray-300 cursor-default ${
