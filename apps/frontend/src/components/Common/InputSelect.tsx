...
const InputSelect: FC<Iprops> = ({ ...props }: Iprops) => {
  ...
  return (
    <select
      className={`appearance-none block w-full px-3 py-2 border rounded-md shadow-sm placeholder-gray-400 focus:outline-hidden  focus:border-indigo-500 sm:text-sm pr-10 ${
