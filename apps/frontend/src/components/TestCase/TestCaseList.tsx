    ...
    <div>
      ...
      <div className="w-full">
        {isLoading ? (
          ...
          <div className="grid items-start grid-cols-3 gap-2 lg:grid-cols-4 lg:gap-2 overflow-hidden">
            <div className=" overflow-x-auto mx-6 sm:mx-0  col-span-2 lg:col-span-3 height-threshold">
              <div className="py-4 align-middle inline-block min-w-full px-7 2xl:pl-12">
                ...
                >
                  <div
                    id="pdf-header"
                    className="item-center justify-center font-medium text-gray-900 py-3 hidden"
                  >
