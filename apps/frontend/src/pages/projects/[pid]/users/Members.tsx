                  ...
                  <div className="bg-white">
                    <div className="px-2 md:px-4 py-5 sm:p-6 2xl:pr-52">
                      ...
                      <Button
                        ...
                        type="button"
                        className="inline-flex items-center rounded-md bg-indigo-600 mt-3 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 "
                      >
                        {t("Add Member")}
                      </Button>
                    </div>
